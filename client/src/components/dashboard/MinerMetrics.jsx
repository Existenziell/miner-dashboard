...
function SortableGauge({ id, isDragActive, ...gaugeProps }) {
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 right-1 z-10 cursor-grab active:cursor-grabbing touch-none p-1 rounded opacity-0 transition-opacity group-hover:opacity-100 text-muted dark:text-muted-dark hover:text-body"
