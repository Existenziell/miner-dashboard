  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <section>
        ...
        <ul className="list-disc list-inside text-text-primary text-sm leading-relaxed space-y-1 mb-2">
        ...
        <p className="text-text-primary text-sm leading-relaxed">
          Set the miner’s IP in the dashboard settings (or <code className="px-1.5 py-0.5 rounded bg-surface-light text-btc-orange text-xs">.env</code>) so the backend can poll status and show hashrate, temperature, power, and fan data.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-text-primary text-sm leading-relaxed">
          Configure your miner with the pool’s Stratum endpoint (e.g. <code className="px-1.5 py-0.5 rounded bg-surface-light text-btc-orange text-xs">stratum+tcp://pool.example.com:3333</code> or <code className="px-1.5 py-0.5 rounded bg-surface-light text-btc-orange text-xs">stratum+ssl://...</code>) and your Bitcoin address. The dashboard does not replace Stratum; it only monitors the miner’s status and the Bitcoin network.
        </p>
      </section>

      <section>
        <h2 className="text-lg font-semibold text-btc-orange mb-2">Dashboard vs miner vs pool</h2>
        <ul className="list-disc list-inside text-text-primary text-sm leading-relaxed space-y-1">
