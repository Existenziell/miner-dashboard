export default function DocumentationPage() {
  return (
    <div className="space-y-8 max-w-3xl card mx-auto">
      <section>
        <h2 className="text-xl font-semibold mb-2">Solo mining via a pool</h2>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">Stratum</h2>
        <p className="doc-body mb-2">
      ...
      <section>
        <h2 className="text-xl font-semibold mb-2">Dashboard vs miner vs pool</h2>
        <ul className="list-disc list-inside doc-body space-y-1">
