...
export const DASHBOARD_DEFAULTS = {
  ...
  metricRanges: {
    hashrate: { min: 5500, gaugeMax: 7000 },
    efficiency: { max: 25, gaugeMax: 30 },
    temp: { max: 65, gaugeMax: 85 },
    fanRpm: { maxPct: 75 },
    current: { max: 9.75, gaugeMax: 10.5 },
    frequency: { min: 650, gaugeMax: 850 },
    voltage: { maxMv: 50, gaugeMax: 1400 },
    power: { max: 117.5, gaugeMax: 130 },
  },
};
