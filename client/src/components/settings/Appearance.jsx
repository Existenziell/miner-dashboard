    ...
    <div className="space-y-4">
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-standalone text-xs my-3 space-y-1">
      ...
      <div className="card">
        ...
        <p className="text-muted-standalone text-sm my-6 space-y-1">
          <span className="block"><strong>Accent color:</strong> Buttons, links, and highlights. Darker shade is derived automatically.</span>
          <span className="block"><strong>Chart colors:</strong> Line colors for Power, Temperature, and Hashrate charts.</span>
        </p>
        <div className="space-y-4">
